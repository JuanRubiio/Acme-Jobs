...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption code="master.menu.anonymous.investorRecord.list" action="/anonymous/investorRecord/list"/>
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.investorRecord" access="isAuthenticated()">
			<acme:menu-suboption code="master.menu.investorRecord.list" action="/authenticated/investorRecord/list"/>
		</acme:menu-option>
